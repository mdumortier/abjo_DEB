...
nbyears = 5; % years - simulation duration
...
pars.V_O0 = 6.4*10^(-8); % cm^3 - Otolith volume
...
%% 4.2. Core parameters
pars.p_Am = 311.682; %311.682; %770; % J.d-1.cm-2 - maximum surface specific assimilation rate
pars.p_M = 127.831; % J.d-1.cm-3 - vol-specific somatic maintenance
pars.p_T = 0; % J.d.cm-3 - Surf-spec somatic maintenance 
pars.v = 0.08581; % cm.d-1 - Energy conductance
pars.kap = 0.97993; % - Allocation fraction to soma (growth + somatic maintenance)
pars.kap_R = 0.95; % - Reproduction efficiency
pars.k_J = 0.002; %0.015; % d-1 - Maturity maintenance rate coefficient
pars.E_G  = 5220.69; % J.cm-3 - Volume spec cost for struct

%% 4.3. Energy maturity threshold
pars.E_Hb = 0.01515; % J - Maturity at birth
pars.E_Hj = 0.4352; % Maturity at metamorphosis
pars.E_Hp = 24270; % J - Maturity at puberty
...
pars.d_V = 0.00005; % g.cm-3 - Specific density of structure
pars.w_E = 20; % g.mol-1 - Specific weight of reserve
pars.w_V = 20; % g.mol-1 - Specific weight of structure 
pars.mu_E = 300000; %468440; % J.mol-1 - Chemical potential of reserve
pars.mu_V = 10000; % J.mol-1 - Chemical potential of structure
